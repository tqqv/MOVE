  ...
  <div class="h-screen flex relative z-50">
    <div class="flex flex-col items-center justify-center gap-y w-1/3 ml-32">
      <div class="flex justify-start w-full">
        <span class="text-[30px] font-semibold" v-if="userStore.user?.banned?.expiresAt"> {{countdown}}</span>
        <span class="text-[30px] font-semibold" v-else>You have been <span class="text-[30px] font-bold text-red uppercase">permanently banned</span> .</span>
      </div>
