  ...
  <div v-else>
    <div v-if="!showStates" class="bg-white shadow-lg p-4 rounded-md text-black space-y-2 w-1/2">
      ...
      >
        <div class="flex gap-2">
          ...
          <div
            class="text-base transition duration-200 ease-in-out"
            :class="{ 'hover:underline hover:text-primary cursor-pointer': stat.country }"
    ...
    <div v-else class="bg-white shadow-lg p-6 rounded-md text-black space-y-2 w-1/2">
      <div class="space-y-4">
        ...
        <div v-if="selectedCountryIndex !== null">
