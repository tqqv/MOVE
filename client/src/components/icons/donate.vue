<template>
  ...
  >
    <g>
      <path
        d="m415.534 259.599-48.6-17.701c-1.5-.599-3.3-.899-5.099-.899h-311.4c-8.401 0-15 6.599-15 15v211c0 24.899 20.099 45 45 45h300c24.901 0 45-20.101 45-45V273.698c0-6.299-3.901-11.999-9.901-14.099z"
        style=""
        fill="#fc1a40"
        data-original="#fc1a40"
      ></path>
      <path
      ...
      ></path>
      <path
        d="M185.435 240.999v271h90v-271h-90zM238.535 99.398l-8.101 22.2-32.999 90.601 32.999 12.001 37.5 13.5 14.099 5.099 41.102-112.8-84.6-30.601z"
        style=""
        fill="#fcbf29"
        data-original="#fcbf29"
      ></path>
      <path
        d="M230.439 240.999h45v271h-45zM323.135 129.999l-41.101 112.8-14.099-5.1-37.5-13.5V121.598l8.1-22.2z"
        style=""
        fill="#fe9923"
        data-original="#fe9923"
      ></path>
