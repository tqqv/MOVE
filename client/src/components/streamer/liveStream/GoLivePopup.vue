...
<template>
  <section class="absolute w-[89%] bottom-24 rounded-lg bg-white shadow-md">
    <div class="container">
      ...
      <div v-if="time === 0" class="flex flex-col justify-center items-center gap-y-6 mt-6">
        <h1 class="text_title p-0">Live video is starting</h1>
        <div><SmallLoading width="50px" height="50px" /></div>
      </div>
    </div>
  </section>
</template>
